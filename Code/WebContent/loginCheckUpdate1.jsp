...
try
{
    ...
    PreparedStatement pstmt=con.prepareStatement("select * from FacultyDetails where id=? ");
    ...
    out.println("<p align='center' style='color:white;font-size:40px;font-style:italic;font-weight:bold'><a href='change1.jsp?id="+id+"' style='color:white ;font-size:20px;font-style:italic;font-weight:bold'>Click for updation</p></a>");
    ...
    out.println("<p align='center' style='color:white;font-size:30px;font-style:italic;font-weight:bold'><a href='indexUpdate1.html'style='color:white ;font-size:20px;font-style:italic;font-weight:bold' >Click for updation</p></a>");
