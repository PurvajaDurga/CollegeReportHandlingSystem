...
try
{
    ...
    out.println("<p align='center' style='color:white;font-size:40px;font-style:italic;font-weight:bold'><a href='changestudent.jsp?id="+id+"' style='color:white ;font-size:20px;font-style:italic;font-weight:bold'>Display Details</p></a>");
    ...
    out.println("<p align='center' style='color:white;font-size:30px;font-style:italic;font-weight:bold'><a href='studentUpdate.html'style='color:white ;font-size:20px;font-style:italic;font-weight:bold' >Click here</p></a>");
