...
try
{
    ...
    PreparedStatement pstmt=con.prepareStatement("select * from ud2 where uname=? and pwd=? ");
    ...
    out.println("<p align='center' style='color:white;font-size:40px;font-style:italic;font-weight:bold'><a href='displayacademics.jsp' style='color:white ;font-size:20px;font-style:italic;font-weight:bold'>Check your Updated Academic Details</p></a>");
   ...
   out.println("</body></html>");
    ...
    out.println("<p align='center'><a href='changepwd2.jsp?uname="+uname+"' style='color:white ;font-size:20px;font-style:italic;font-weight:bold'>Forget Password</a>");
    out.println("</body></html>");
    }
